...
const array<int, 13> Date::days{0, 31, 28, 
...
bool Date::operator<(const Date& dd){
    ...
    else if (this->year == dd.year && this->month < dd.month){
        return true;
    }
    else if (this->year == dd.year && this->month == dd.month && this->day < dd.day){
        return true;
    }
...
bool Date::operator != (const Date& dd){
    ...
    if ((this->year == dd.year) && (this->month == dd.month) && (this->day == dd.day))
        return false;
...
bool Date::operator==(const Date& d) {return year==d.year && month==d.month && day==d.day;}
